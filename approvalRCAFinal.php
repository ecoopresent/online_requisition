...
$alert_color = "success";
if($rca_status=="Finished" || $rca_status=="PreApproved"){
    $rca_status = "approved";
}
            ...
            <div class="row">
                <div class="col col-12">
                    ...
                    <ul class="timeline mt-5">
                        ...
                        <?php elseif($approver_type=="three"): ?>
                            <li class="done">
                                <span class="fw-bold">Jasmine Padernal</span>
                                <span class="float-end text-secondary">Signed</span>
                                <p class="text-secondary">Department Head</p>
                            </li>
                        <?php elseif($approver_type=="threeB"): ?>
                            <li class="done">
                        ...
                        <?php if ($approver=="Aida D. Sion"): ?>
                            <li>
                                <span class="fw-bold">Aida D. Sion</span>
                                <span class="float-end text-secondary">Pending</span>
                                <p class="text-secondary">VP Comptroller</p>
                            </li>
                        <?php else: ?>
                            <li>
