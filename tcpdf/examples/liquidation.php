...
foreach ($Routedetails as $k => $v) {
	...
	$amountperline = number_format($v['amount'],2);
	$html .=	'<tr>
					...
					<td style="width: 14%;border-right: 1px solid black;border-top: 1px solid black;text-align:center;font-size: 8.5px">'.$v['l_from'].'</td>
					<td style="width: 14%;border-right: 1px solid black;border-top: 1px solid black;text-align:center;font-size: 8.5px">'.$v['l_to'].'</td>
					<td style="width: 20%;border-right: 1px solid black;border-top: 1px solid black;text-align:center;font-size: 9.5px">'.$v['vehicle_type'].'</td>
					<td style="width: 15%;border-right: 1px solid black;border-top: 1px solid black;text-align:center;font-size: 9.5px">'.$amountperline.'</td>
				</tr>';
	$a++;
...
for($x=0;$x<$rows;$x++){
	...
	$html .=	'<tr>
					...
					<td style="width: 15%;border-right: 1px solid black;border-top: 1px solid black;text-align:center;font-size: 9.5px">'.number_format($totalamount,2).'</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="3" style="width: 33%;border-left: 1px solid black;border-right: 1px solid black;text-align:center">'.$liquidationInfo['name'].'</td>
