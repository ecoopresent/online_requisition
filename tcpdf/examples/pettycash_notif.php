...
$mail->Subject = "NEW APPROVED LIQUIDATION";
$badie = 'You have new approved Liquidation to your dashboard. Go to website to check. click this -> <a href="https://panamed.com.ph/online_requisition/login.php">Online Requisition Form</a>';
$mail->Body = $badie;
