...
function approve_Canvas(id){
  ...
  if(r==true){
    ...
    var c = post_Data('controller.canvasing.php?mode=UpdateCanvasPre',{
      id: id,
    ...
    toggleLoad();
    window.location.href="tcpdf/examples/pr_emailpresident.php?id="+id; 
  }
  
}

function approve_CanvasPres(id){
  var r = confirm("Approve Canvas?");
  if(r==true){
    ...
    alert("Approved");
    window.location.href="approvalCanvasPresident.php?id="+id+"&approver="; 
  }
}
...
function disapprove_CanvasLocal(id){
  var r = confirm("Disapprove Canvas?");
  if(r==true){
    var c = post_Data('controller.canvasing.php?mode=UpdateCanvas',{
      id: id,
      canvas_status: "Rejected1",
      remarks: $('#remarks').val(),
      approver: $('#approver').val()
    });
    alert("Disapproved");
    window.location.href="approvalCanvasLocal.php?id="+id+"&approver=";  
  }
}

function disapprove_CanvasPres(id){
  var r = confirm("Disapprove Canvas?");
  if(r==true){
    var c = post_Data('controller.canvasing.php?mode=UpdateCanvas',{
      id: id,
