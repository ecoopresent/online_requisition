...
$(document).ready(function(){
    ...
    $('#pri1').on('keyup', function(){
        var pri = $('#pri1').val();
        var qty = $('#qty').val();
        var totalprice = pri * qty;
        $('#price1').val(totalprice);
    });

    $('#pri2').on('keyup', function(){
        var pri = $('#pri2').val();
        var qty = $('#qty').val();
        var totalprice = pri * qty;
    ...
    $('#pri3').on('keyup', function(){
        var pri = $('#pri3').val();
        var qty = $('#qty').val();
        var totalprice = pri * qty;
        $('#price3').val(totalprice);
    });

    $('#pri4').on('keyup', function(){
        var pri = $('#pri4').val();
        var qty = $('#qty').val();
        var totalprice = pri * qty;
        $('#price4').val(totalprice);
    });

    $('#pri5').on('keyup', function(){
        var pri = $('#pri5').val();
        var qty = $('#qty').val();
        var totalprice = pri * qty;
        $('#price5').val(totalprice);
    });
