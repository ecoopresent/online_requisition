...
$final_approver = "Homer C. Lim";
$nameApprover = "Jerome T. Chua";
if($approver=="twoB"){
    $final_approver = "Aida D. Sion";
}
if($approver=="oneB"){
    $nameApprover = "Susan T. Panugayan";
    // $e_address = "susan.panugayan@pmc.ph";
    $e_address = "jericopresentacion08@gmail.com";
}
if($approver=="twoC"){
    $final_approver = "Jerome T. Chua";
    $nameApprover = "Jovan D. Palma";
    $e_address = "jericopresentacion08@gmail.com";
    // $e_address = "jdpalma@panamed.com.ph";
}
...
if($approver=="twoF"){
    ...
    $e_address = "jericopresentacion08@gmail.com";
    // $e_address = "jalagumbayan@panamed.com.ph";
}
if($approver=="twoD"){
                        ...
                        <td style="padding:80px 50px; background-color:#e8f1fd;">
                            <table width="100%" cellpadding="0" cellspacing="0" style="min-width:100%;">
                                <tbody>
                                    ...
                                    if($approver !="one" && $approver !="oneB"){


                                        $badie .=    '<tr>
                                                        <td style="width: 33%;"></td>
                                                        <td style="padding:5px;font-family: Arial,sans-serif; font-size: 14px; line-height:20px;text-align:left;">
                                                            <img src="https://pmc.ph/email_assets/pending.png" width="25" style="vertical-align: middle;" /> &nbsp; &nbsp; '.$final_approver.'
                                                        </td>
                                                    </tr>';
                                    }
                                     $badie .=   '</tbody>
