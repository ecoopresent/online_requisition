...
// $button_link = "https://panamed.com.ph/online_requisition/approvalCashCheckHead.php?id=$pr_id&approver=Jerome T. Chua";
$button_link = "http://192.168.101.41/online_requisition/approvalCashCheckHead.php?id=$pr_id&approver=Jerome T. Chua";
...
$pdffile = $pdf->Output('CashAdvance.pdf', 'S');
    ...
    // echo "Email sent";
    header('location:../../approvedPr.php');
    }
