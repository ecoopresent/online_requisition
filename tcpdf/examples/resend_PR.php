...
$pr_approver = $pr_info['approved_by'].'<br>Signed '.$pr_info['date_approve'];
if($pr_info['date_approve']=="" || $pr_info['date_approve']==null){
	$pr_approver = "";
 	  ...
 	  $html .= '<tr>
					...
					<td style="width: 29%;border-bottom: 1px solid #0d0d0d;border-right: 1px solid #0d0d0d" align="center">'.$pr_approver.'</td>
				</tr>
				<tr>
