...
$mail->Subject = "NEW APPROVED PETTY CASH";
$badie = 'You have new approved Petty Cash to your dashboard. Go to website to check. click this -> <a href="https://panamed.com.ph/online_requisition/login.php">Online Requisition Form</a>';
$mail->Body = $badie;
...
if(!$mail->Send()) {
    ...
    // echo "Email sent";
    header('location:../../approvalPettycashFinal.php?id='.$id.'&approver=');
}
