...
$html .= '<table width="100%" border="0" style="font-size: 11px">
				...
				<tr>
					...
					<td style="border-left: 1px solid black;width: 25%;font-size: 10px;text-align:center">'.$extra_approver.''.$cash_info['department_head'].'</td>
...
$pdffile = $pdf->Output('CashAdvance.pdf', 'S');
    ...
    // echo "Email sent";
    header('location:../../approvalRCAExtra.php?id='.$cash_id.'&approver=&at=');
    }
