    ...
    <div class="col col-md-12">
        ...
        <div class="tab_container">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" id="Tabtab" href="#home"><i class="fas fa-md fa-user-plus"></i> RCA Requests</a>
                </li>
            </ul>
                ...
                <div id="home" class="tab-pane active"><br>
                    ...
                    <div class="rowx">
                        ...
                        <div class="responsive-table mt-2">
                            <table id="rcaadminTable" class="table" width="100%">
                                <thead>
                                    <th></th>
...
<script type="text/javascript">
    <?php 
        include 'services/rca_admin/rca_admin.js';
