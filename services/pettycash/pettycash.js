...
$(document).ready(function(){
    ...
    $('#pettyPreapprovedPC').on('click',function(){
      btn_cancelPetty();
      var statuss = "PreApp";
      load_PettycashList(statuss);
    });
...
function reSendPC(id){
  confirmed("save",reSendPC_callback, "Do you really want to resend this?", "Yes", "No", id);
  
}
function reSendPC_callback(id){
  toggleLoad();
  window.location.href="tcpdf/examples/pcFinalresend.php?id="+id;
}
...
function sendPetty_callback(id){
    ...
    toggleLoad();
    window.location.href="tcpdf/examples/pcHead.php?id="+id+"&n="+name_Approver+"&e="+email_Approver;
}
