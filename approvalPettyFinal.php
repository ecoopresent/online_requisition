...
$id = $_GET['id'];
$status = $pettycash->checkStatusAuthorFinal($id);
            ...
            <div class="row">
                <div class="col col-12">
                    ...
                    <ul class="timeline mt-5">
                        ...
                        <li class="done">
                            <span class="fw-bold"><?php echo $voucher_info[2]; ?></span>
                            <span class="float-end text-secondary">Signed</span>
                        ...
                        <li>
                            ...
                            <p class="text-secondary">Final Approver</p>
                        </li>
                    </ul>
                    <?php } ?>
                </div>
                ...
                <div class="col col-12">
                    <div class="my-3 text-end">
                        ...
                        <button type="submit" class="btn btn-success mb-3" onclick="finalapprove_Petty(<?= $id ?>)">Approve</button>
                        <button type="submit" class="btn btn-danger mb-3" onclick="finaldisapprove_Petty(<?= $id ?>)">Disapprove</button>
                    </div>
                </div>
