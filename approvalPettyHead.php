...
$status = $pettycash->checkStatus($id);
            ...
            <div class="row">
                ...
                <div class="col col-12">
                    <div class="my-3 text-end">
                        ...
                        <button type="submit" class="btn btn-danger mb-3" onclick="disapprove_Petty(<?= $id ?>)">Disapprove</button>
                    </div>
                </div>
