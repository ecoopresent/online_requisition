...
// $button_link = "https://panamed.com.ph/online_requisition/approvalCashCheckFinal.php?id=$pr_id&approver=Homer C. Lim";
$button_link = "http://192.168.101.41/online_requisition/approvalCashCheckFinal.php?id=$pr_id&approver=Homer C. Lim";
...
$pdffile = $pdf->Output('CashAdvance.pdf', 'S');
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td style="padding:5px;font-family: Arial,sans-serif; font-size: 14px; line-height:20px;text-align:left;">
                                                            <img src="https://pmc.ph/email_assets/done.png" width="25" style="vertical-align: middle;" /> &nbsp; &nbsp; <b>Marjorie Barona</b>
                                                        </td>
                                                    </tr>
    ...
    // echo "Email sent";
    header('location:../../approvalCashCheckHead.php?id='.$pr_id."&approver=");
    }
