...
$status = $pettycash->checkStatusAuthor($id);
            ...
            <div class="row">
                ...
                <div class="col col-12">
                    <div class="my-3 text-end">
                        ...
                        <button type="submit" class="btn btn-success mb-3" onclick="approve_FinalPC(<?= $id ?>)">Approve</button>
                        <button type="submit" class="btn btn-danger mb-3" onclick="disapprove_PettycashFinal(<?= $id ?>)">Disapprove</button>
                    </div>
                </div>
