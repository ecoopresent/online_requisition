...
// $button_link = "https://panamed.com.ph/online_requisition/approvalPettycashHead.php?id=$id&approver=$name_Approver";
$button_link = "http://192.168.101.41/online_requisition/approvalPettycashHead.php?id=$id&approver=$name_Approver";
...
$mail->Subject = "Dept: ".$department."- Petty Cash Request VOUCHER ( ".$voucher_no." )";
