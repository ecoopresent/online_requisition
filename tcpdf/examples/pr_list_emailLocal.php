...
$name_Approver = "Susan T. Panugayan";
$depts = $pr_info['department'];

// $button_link = "https://pmc.ph/online_requisition/approvalCanvasLocal.php?id=$pr_id&approver=$name_Approver";
$button_link = "http://192.168.101.41/online_requisition/approvalCanvasLocal.php?id=$pr_id&approver=$name_Approver";
