...
class PettycashApproval extends DBHandler {
    ...
    public function UpdateStatus($id,$pettycash_status,$approver,$remarks)
    {
        ...
        $query = "UPDATE pettycash SET approved_by = '$approver', pettycash_status = '$pettycash_status', remarks = '$remarks' WHERE id = '$id'";
        $stmt = $this->prepareQuery($this->conn, $query);
        $this->execute($stmt);

        $query = "UPDATE liquidation SET checked_by = '$approver' WHERE pettycash_id = '$id'";
        $stmt = $this->prepareQuery($this->conn, $query);
        return $this->execute($stmt);
    }

    public function ITUpdateStatus($id,$pettycash_status,$approver,$remarks)
    {
        if($pettycash_status=="Submitted"){
            $full_name = "";
        }
    ...
    public function UpdateStatcash($id,$pettycash_status,$approver,$remarks)
    {
        ...
        $query = "UPDATE pettycash SET pettycash_status = '$pettycash_status', approved_by = '$approver', authorized = '$approver' WHERE id = '$id'";
        $stmt = $this->prepareQuery($this->conn, $query);
        $this->execute($stmt);

    }

    public function PCUpdateStatcash($id,$pettycash_status,$approver,$remarks)
    {

        $query = "UPDATE pettycash SET pettycash_status = '$pettycash_status', approved_by = '$approver', remarks = '$remarks' WHERE id = '$id'";
        $stmt = $this->prepareQuery($this->conn, $query);
        $this->execute($stmt);

    }

    public function PCFinalUpdateStatcash($id,$pettycash_status,$approver,$remarks)
    {

        $query = "UPDATE pettycash SET pettycash_status = '$pettycash_status', authorized = '$approver', remarks = '$remarks' WHERE id = '$id'";
        $stmt = $this->prepareQuery($this->conn, $query);
        $this->execute($stmt);
