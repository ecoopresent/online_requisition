...
switch($mode) {
    ...
    case "ITUpdateStat";
        ...
        $remarks = Sanitizer::filter('remarks', 'post');
        $approver = Sanitizer::filter('approver', 'post');
        $petty_approval->ITUpdateStatus($id,$pettycash_status,$approver,$remarks);
        $response = array("code"=>1,"message"=>"Petty Cash Status Updated");
        break;
    ...
    case "PCUpdateStatcash";

        $id = Sanitizer::filter('id', 'post');
        $pettycash_status = Sanitizer::filter('pettycash_status', 'post');
        $remarks = Sanitizer::filter('remarks', 'post');
        $approver = Sanitizer::filter('approver', 'post');
        $petty_approval->PCUpdateStatcash($id,$pettycash_status,$approver,$remarks);
        $response = array("code"=>1,"message"=>"Petty Cash Status Updated");
        break;

    case "PCfinalUpdateStatcash";
        $id = Sanitizer::filter('id', 'post');
        $pettycash_status = Sanitizer::filter('pettycash_status', 'post');
        $remarks = Sanitizer::filter('remarks', 'post');
        $approver = Sanitizer::filter('approver', 'post');
        $petty_approval->PCFinalUpdateStatcash($id,$pettycash_status,$approver,$remarks);
        $response = array("code"=>1,"message"=>"Petty Cash Status Updated");
        break;
