...
$html .= '<table width="100%" border="0" style="font-size: 11px">
				...
				<tr>
					<td colspan="2" style="border-left: 1px solid black;width: 34%;font-size: 10px;text-align:center">'.$requested_by.'<br> Signed '.$voucher_date.'</td>
					<td style="border-left: 1px solid black;width: 33%;font-size: 10px;text-align:center">'.$department_head.'<br> Signed '.$voucher_date.'</td>
					<td style="border-right: 1px solid black;width: 33%;font-size: 10px;text-align:center">'.$authorized_signatory.'<br> Signed '.$voucher_date.'</td>
				</tr>
				<tr>
