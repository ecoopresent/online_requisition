               ...
               <div class="modal-body">
                    ...
                    <div class="col col-md-12 mt-2">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="price1" value="0" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                        </div>
                    </div>
                    ...
                    <div class="col col-md-12 mt-2">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="price2" value="0" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                        </div>
                    </div>
                    ...
                    <div class="col col-md-12 mt-2">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="price3" value="0" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                        </div>
                    </div>
                    ...
                    <div class="col col-md-12 mt-2">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="price4" value="0" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                        </div>
                    </div>
                    ...
                    <div class="col col-md-12 mt-2">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="price5" value="0" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                        </div>
                    </div>
