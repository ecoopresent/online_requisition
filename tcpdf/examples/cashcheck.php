...
if($cash_info['date_preapproved']=="0000-00-00"){
	$cash_info['date_preapproved'] = "";
}else{
...
$html .= '<table width="100%" border="0" style="font-size: 11px">
				...
				<tr>
					...
					<td style="border-left: 1px solid black;width: 25%;font-size: 10px;text-align:center">'.$cash_info['department_head'].'<br> '.$cash_info['date_preapproved'].'</td>
					<td style="width: 25%;font-size: 10px;text-align:center">'.$cash_info['president'].'<br> '.$cash_info['date_approved'].'</td>
